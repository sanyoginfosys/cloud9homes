...
define('YOUR_EMAIL','ksamayrananda@gmail.com');
...
$smtpHost = "mail.cloud9homes.com.au"; // SMTP servers

$smtpUsername = "no-reply@cloud9homes.com.au";  // SMTP username 

$smtpPassword = "agoeqdzmkgeomqbe"; // SMTP password

$smtpFrom     = "no-reply@cloud9homes.com.au"; // SMTP Sender email

 

$smtpFromname = $_POST['name']; //Sender name
...

{
...

	{
			...
			//$smtpHost = "cs3001.webhostbox.net"; // SMTP servers
			$smtpHost = '';
			...
			$smtpFromname = "No-Reply Cloud9Homes"; //Sender name
			...
			if($smtpHost && $smtpUsername && $smtpPassword && $smtpFrom && $smtpFromname ) {
...

				{
					...
					//'<div class="error-box">Error. Please try again.<div class="small-triangle"></div><div class="small-icon"><i class="jfont">&#xe80f;</i></div></div>';			
					echo $mail->ErrorInfo;
