<?php
	...
	if(isset($_POST['propertytype'],$_POST['transaction'])){	
		...
		$submitted = lead_property_details_UPLOAD($_POST['propertytype'],$_POST['transaction'],$_POST['price'],$_POST['area'],$_POST['bedrooms'],$_POST['bathrooms'],str_replace('\'', '\\\'', $_POST['message']),$_POST['cc1'],$_POST['cc2'],$_POST['cc3'],$_POST['cc4'],$_POST['cc5'],$_POST['cc6'],$_POST['cc7'],$_POST['cc8'],$_POST['cc9'],$_POST['cc10'],$_POST['cc11'],$_POST['cc12'],$_POST['cc13'],$_POST['cc14'],$_POST['cc15'],$_POST['cc16'],$_POST['cc17'],$_POST['cc18'],$_POST['lng'],$_POST['lat'],$_POST['person_name'],$_POST['phoneno'],$_POST['emailid'],$_POST['property-address']);
	}
?>
<!DOCTYPE html>
<html lang="en">
<?php print_head('Edit Property'); ?>
<body>
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-lg-12 short-image-title">
					<h5 class="subtitle-margin second-color">Edit listing</h5>
