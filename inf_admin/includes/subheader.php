...
?>
<!-- begin:: Subheader -->
<div class="kt-subheader   kt-grid__item" id="kt_subheader" style="top: 0px;">
    <div class="kt-subheader__main">
        <h3 class="kt-subheader__title">
            <?php echo SITE_TITLE; ?> </h3>
        <span class="kt-subheader__separator kt-hidden"></span>
        <div class="kt-subheader__breadcrumbs">
            <a href="<?php echo ADMIN_URL; ?>" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
    ...
    <div class="kt-subheader__toolbar">
        <div class="kt-subheader__wrapper">
            <a href="#" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker" data-placement="left">
                <span class="kt-subheader__btn-daterange-title" id="kt_dashboard_daterangepicker_title">Today</span>&nbsp;
                <span class="kt-subheader__btn-daterange-date" id="kt_dashboard_daterangepicker_date"><?php echo date("M")." ".date("d"); ?></span>
                    ...
                    <ul class="kt-nav">
                        ...
                        <li class="kt-nav__item">
                            <a href="#" class="kt-nav__link">
                                ...
                                <span class="kt-nav__link-text">Property</span>
                            </a>
                        </li>
                        <!-- <li class="kt-nav__item">
                            <a href="#" class="kt-nav__link">
                        ...
                        <li class="kt-nav__item">
                            <a href="#" class="kt-nav__link">
                                ...
                                <span class="kt-nav__link-text">Invoice</span>
                            </a>
                        </li>
                    </ul>
                </div>
