...
<html>
<head>
	<title>Manage Lead Property | <?php echo SITE_TITLE; ?></title>
...
<body class="kt-header--fixed kt-header-mobile--fixed kt-subheader--fixed kt-subhepader--enabled kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading">
		...
		<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
			...
			if(isset($_GET['success'])){
				...
				<div class="alert alert-success" role="alert">
					<div class="alert-text">Lead Property is now copied to Property!</div>
				</div>
				<?php
			}
			?>
						...
						<div class="kt-portlet__head kt-portlet__head--lg">
							<div class="kt-portlet__head-label">
								<span class="kt-portlet__head-icon">
									<i class="kt-font-brand fa fa-cloud-download-alt"></i>
								</span>
	...
	<script src="tables/js/manage_lead_property.js" type="text/javascript"></script>
