<?php
	...
	if(isset($_GET['property_slug'])){
		if($_GET['property_slug'] != NULL OR $_GET['property_slug'] != ""){
			$PropertyDetail = PropertyPage_GetProperty($_GET['property_slug']);
			$site_link = 'https://'.$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
		}	else 	{
			header('location: '.ERROR_404);
		}
		if($PropertyDetail['is_live'] == 0)
			header('location: '.ERROR_404);
		if($PropertyDetail == 0){
			header('location: '.ERROR_404);
		}
...
<!DOCTYPE html>
<html lang="en">
<meta property="og:url" content="<?php echo $site_link ?>">
<meta property="og:image" content="<?php echo 'https://cloud9homes.com.au/'.$PropertyDetail['images'][0] ?>">
<?php print_head($PropertyDetail['address']); ?>
<body>
    ...
    <section class="section-dark no-padding">
		...
		<div id="swiper-gallery" class="swiper-container">
			...
			<div class="swiper-wrapper">
				...
				<!-- Slides -->
				<?php
					for($i=0; $i<count($PropertyDetail['images']); $i++){
						echo "<div class='swiper-slide'>
							<div class='slide-bg swiper-lazy' data-background='".HOME_URL.$PropertyDetail['images'][$i]."' data-sub-html='<strong>this is a caption 1</strong><br/>Second line of the caption'></div>
							<!-- Preloader image -->
										...
										<div class='gallery-slide-cont'>
											<div class='gallery-slide-cont-inner'>	
												<div class='gallery-slide-title pull-right'>
													<h5 class='subtitle-margin'>".$PropertyDetail['property_type'].' '.$PropertyDetail['transaction']."</h5>
													<h3>".$PropertyDetail['address']."<span class='special-color'>.</span></h3>
												</div>
											...
											<div class='clearfix'></div>
											<div class='gallery-slide-desc-price pull-right'>".'$'.$PropertyDetail['price'];
													if($PropertyDetail['transaction'] == 'For Rent' OR $PropertyDetail['transaction'] == 'Rented'){
														echo ' /week';
													}
												echo "</div>	
											<div class='clearfix'></div>
					...
					<div id="swiper-thumbs" class="swiper-container">
						...
						<div class="swiper-wrapper">
							...
							<?php
								for($i=0; $i<count($PropertyDetail['images']); $i++){
						echo '<div class="swiper-slide">
								<img class="slide-thumb" src="'.HOME_URL.$PropertyDetail['images'][$i].'" alt="" style="max-width: 120px;">
							</div>
							';
								}
							?>
						...
						<!-- 	<div class="swiper-slide">
								<img class="slide-thumb" src="<?php echo HOME_URL; ?>images/slides/m11.jpg" alt="">
							</div>
							<div class="swiper-slide">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-7 col-md-8">
							...
							<div class="details-title pull-left">
								<h5 class="subtitle-margin"><?php echo $PropertyDetail['property_type'].' '.$PropertyDetail['transaction']; ?></h5>
								<h3><?php echo $PropertyDetail['address']; ?><span class="special-color">.</span></h3>
							</div>
							<div class="clearfix"></div>	
							<div class="title-separator-primary"></div>
							<p class="details-desc"><br/>
								<?php echo $PropertyDetail['description']; ?><br />
								<div class="row margin-top-30 centered-text">
									<div class="col-xs-12 col-sm-4">
										<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $site_link; ?>" class="button-primary button-shadow" target="_blank">
											<span>Share</span>
											<div class="button-triangle"></div>
											<div class="button-triangle2"></div>
											<div class="button-icon"><i class="fa fa-facebook-f"></i></div>
										</a>
									</div>
								</div>
							</p>
						...
						<div class="col-xs-12 col-sm-5 col-md-4">
							<div class="details-parameters-price"><?php echo '$'.$PropertyDetail['price'];if($PropertyDetail['transaction'] == 'For Rent' OR $PropertyDetail['transaction'] == 'Rented'){echo " /week";}?></div>
							<div class="details-parameters">
								<div class="details-parameters-cont">
									<div class="details-parameters-name">Property Type</div>
									<div class="details-parameters-val"><?php echo $PropertyDetail['property_type']; ?></div>
									<div class="clearfix"></div>	
								</div>
								<div class="details-parameters-cont">
									<div class="details-parameters-name">Bedrooms</div>
									<div class="details-parameters-val"><?php echo $PropertyDetail['bedrooms']; ?></div>
									<div class="clearfix"></div>	
								</div>
								<div class="details-parameters-cont">
									<div class="details-parameters-name">Bathrooms</div>
									<div class="details-parameters-val"><?php echo $PropertyDetail['bathrooms']; ?></div>
									<div class="clearfix"></div>	
								</div>
								<div class="details-parameters-cont details-parameters-cont-last">
									<div class="details-parameters-name">Area</div>
									<div class="details-parameters-val"><?php echo $PropertyDetail['area']; ?> m<sup>2</sup></div>
									<div class="clearfix"></div>	
								</div>
								<!-- <div class="details-parameters-cont">
						...
						<div class="row margin-top-30 centered-text">
							<div class="col-xs-12 col-sm-4">
								<a href="https://www.cloud9homes.com.au/uploads/documents/enquiry_form_rental.Pdf" class="button-primary button-shadow">
					...
					<div class="row margin-top-45">
						<div class="col-xs-6 col-sm-12">
							<ul class="details-ticks">
								<?php if($PropertyDetail['air_conditioning'] == 1){echo '<li><i class="jfont">&#xe815;</i>Air Conditioning</li>';}?>
								<?php if($PropertyDetail['Internet'] == 1){echo '<li><i class="jfont">&#xe815;</i>Internet</li>';}?>
								<?php if($PropertyDetail['cable_tv'] == 1){echo '<li><i class="jfont">&#xe815;</i>Cable TV</li>';}?>
								<?php if($PropertyDetail['balcony'] == 1){echo '<li><i class="jfont">&#xe815;</i>Balcony</li>';}?>
								<?php if($PropertyDetail['roof_terrace'] == 1){echo '<li><i class="jfont">&#xe815;</i>Roof Terrace</li>';}?>
								<?php if($PropertyDetail['terrace'] == 1){echo '<li><i class="jfont">&#xe815;</i>Terrace</li>';}?>
								<?php if($PropertyDetail['lift'] == 1){echo '<li><i class="jfont">&#xe815;</i>Lift</li>';}?>
								<?php if($PropertyDetail['garage'] == 1){echo '<li><i class="jfont">&#xe815;</i>Garage</li>';}?>
								<?php if($PropertyDetail['security'] == 1){echo '<li><i class="jfont">&#xe815;</i>Security</li>';}?>
								<?php if($PropertyDetail['high_standard'] == 1){echo '<li><i class="jfont">&#xe815;</i>High Standard</li>';}?>
								<?php if($PropertyDetail['city_centre'] == 1){echo '<li><i class="jfont">&#xe815;</i>City Centre</li>';}?>
								<?php if($PropertyDetail['furniture'] == 1){echo '<li><i class="jfont">&#xe815;</i>Furniture</li>';}?>
							</ul>
						</div>
						...
						<div class="sidebar-select-cont">
							...
							<div class="btn-group bootstrap-select loader-icon-top-suburb" style="display: none;">
								<div class="btn dropdown-toggle btn-default">
									<img src="<?php echo HOME_URL; ?>images/loading-icon.gif" class=" bootstrap-select" style="position: relative;  bottom: 0;  right: 0;  margin: auto; height: 30px; width: 30px;" />
								</div>
							</div>
...
<!-- Script  -->
	<?php print_script(); ?>
			...
			<script type="text/javascript">
				...
				function init() {						
					mapInit(<?php echo $PropertyDetail['latitude'].','.$PropertyDetail['longitude'];?>,"estate-map","<?php echo HOME_URL; ?>images/pin-house.png", true);
					streetViewInit(<?php echo $PropertyDetail['latitude'].','.$PropertyDetail['longitude'];?>,"estate-street-view");
				}
			</script>	
	</body>
</html>